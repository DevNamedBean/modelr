...
function showProjectList() { authScreen.style.display = 'none'; appShell.setAttribute('aria-hidden', 'true'); openProjectModal('projects'); projectModal.style.display = 'grid'; projectModal.style.visibility = 'visible'; }
