...
function showProjectList() { projectModal.classList.remove('open'); appShell.setAttribute('aria-hidden', 'true'); authScreen.style.display = 'none'; openProjectModal('projects'); }
